...
project = "Archivematica Storage Service"
copyright = "2023, Artefactual Systems Inc."
...
man_pages = [
    ("index", "storage_service", "storage_service Documentation", ["ChangeToMyName"], 1)
]
